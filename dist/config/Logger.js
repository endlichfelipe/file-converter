...
const enumerationErrorFormat = winston_1.default.format((info) => {
...
const logger = winston_1.default.createLogger({
    ...
    format: winston_1.default.format.combine(enumerationErrorFormat(), config_1.default.env === 'development'
